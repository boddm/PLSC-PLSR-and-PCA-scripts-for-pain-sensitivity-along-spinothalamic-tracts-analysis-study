...
% Purpose: Feature selection and regression using the PLSC method
% Inputs:
...
%% 1. Data normalization (connectivity matrices only)
...
%% 4. Sign adjustment (ensure largest value is positive)
...
% (when std_left_sv/std_right_sv is near zero)
