...
% Purpose: Permute and sort the data
% Inputs:
%   diagnosis_grouping: grouping vector
%   Time: repeated measurement time
% Output:
%   Result: permuted and sorted vector

%% save the number of groups and number of subjects per group
